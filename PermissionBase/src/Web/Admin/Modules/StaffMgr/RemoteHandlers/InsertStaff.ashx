<%@ WebHandler Language="C#" Class="InsertStaff" %>
...
public class InsertStaff : IHttpHandler, IReadOnlySessionState
{
    private static readonly log4net.ILog log = log4net.LogManager.GetLogger(typeof(InsertStaff));
    ...
    public void ProcessRequest(HttpContext context)
    {
        ...
        {
            //判断访问权限。
            PermissionUtil.CheckSecurity("StaffMgr", "rights_add");
            ...
            dto.Password = xmlDoc.SelectSingleNode("Staff/Password").InnerText;
            ...
            dto.DepartmentId = xmlDoc.SelectSingleNode("Staff/DepartmentId").InnerText;
